                    ...
                    <div class="form-row">
                           <div class="col-md-6">
                            <div class="position-relative form-group" @error('title') has-danger @enderror">
                                <label>Title</label>
                                <input class="form-control @error('title') form-control-danger @enderror" name="title" value="{{ old('title',$article->title) }}"  autocomplete="title" id="title" autofocus type="text">
                            </div>
                            @error('title')
                        ...
                        <div class="col-md-6">
                            <div class="position-relative form-group" @error('sub_sub_category_id') has-danger @enderror">
                                ...
                                <select class="form-control @error('sub_sub_category_id') form-control-danger @enderror" name="sub_sub_category_id" value="{{ old('sub_sub_category_id') }}" autocomplete="sub_sub_category_id">
                                    ...
                                    <option value="{{$subSubCategory->id}}" {{ $subSubCategory->id == $article->sub_sub_category_id ? 'selected' : ''}}> {{ $subSubCategory->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-4">
                                <div class="position-relative form-group" @error('video_url') has-danger @enderror">
                                    ...
                                    <input class="form-control @error('video_url') form-control-danger @enderror" name="video_url" value="{{ old('video_url',$article->video_url) }}"  autocomplete="video_url" id="video_url" autofocus type="text">
                                </div>
                                @error('video_url')
                                        <span class="form-control-feedback">
                                            <strong style="color:red;">{{ $message }}</strong>
                        ...
                        <div class="col-md-4">
                                <div class="position-relative form-group" @error('description') has-danger @enderror">
                                    ...
                                    <input class="form-control @error('description') form-control-danger @enderror" name="description" value="{{ old('description',$article->description) }}"  autocomplete="description" id="description" autofocus type="text">
                                </div>
                                @error('description')
                                        <span class="form-control-feedback">
                                            <strong style="color:red;">{{ $message }}</strong>
                        ...
                        <div class="col-md-4">
                                <div class="position-relative form-group" @error('summary') has-danger @enderror">
                                    <label>Summary</label>
                                    <input class="form-control @error('summary') form-control-danger @enderror" name="summary" value="{{ old('summary',$article->summary) }}"  autocomplete id="summary" autofocus type="text">
                                </div>
                                @error('summary')
                                        <span class="form-control-feedback">
                                            <strong style="color:red;">{{ $message }}</strong>
